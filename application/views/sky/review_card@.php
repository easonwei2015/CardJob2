                        ...
                        <tbody>
							<?php foreach($files_data as $data){ ?>
								...
								<tr>
									...
									<td class="center"><button class="btn btn-primary btn-sm glyphicon glyphicon-download-alt" onclick="window.open('<?php echo $base_url;?>assets/upload_data/review_card/<?php echo $data['file_name'];?>')"></button></td>							
