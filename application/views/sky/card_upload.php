                        ...
                        <tbody>
							<?php foreach($files_data as $data){ ?>
								...
								<tr>
									...
									<?php if($manage_group){?>
										<td class="center"><button class="btn btn-primary btn-sm glyphicon glyphicon-download-alt" onclick="self.location.href='<?php echo $base_url; echo $download_link; echo $data['file_name'];?>'"></button></td>
									<?php }?>
